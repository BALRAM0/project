...
class Bill_App:
    def __init__(self,root):
        ...
        self.a.title("Billing System")
        title=Label(self.a,text="Billing System",bd=14,relief=RIDGE,font=("Arial Black",20),bg="#A569BD",fg="white").pack(fill=X)
        #===================================variables=======================================================================================
        ...
        details=LabelFrame(self.a,text="Customer Details",font=("Arial Black",12),bg="#A569BD",fg="white",relief=GROOVE,bd=12)
        ...
        #=======================================Starters=================================================================
        Starters=LabelFrame(self.a,text="Starters",font=("Arial Black",12),bg="#E5B4F3",fg="#6C3483",relief=GROOVE,bd=10)
        ...
        #===================================Main Course=====================================================================================
        Main_Course=LabelFrame(self.a,text="Main Course",font=("Arial Black",12),relief=GROOVE,bd=10,bg="#E5B4F3",fg="#6C3483")
        ...
        #========================================Desserts===============================================================================
        Desserts=LabelFrame(self.a,text="Desserts",font=("Arial Black",12),relief=GROOVE,bd=10,bg="#E5B4F3",fg="#6C3483")
        ...
        #=====================================================billarea==============================================================================
        billarea=Frame(self.a,bd=10,relief=GROOVE,bg="#E5B4F3")
        ...
        #=================================================billing menu=========================================================================================
        billing_menu=LabelFrame(self.a,text="Billing Summary",font=("Arial Black",12),relief=GROOVE,bd=10,bg="#A569BD",fg="white")
...
def home(self,root):    
    ...
    title.pack(fill=X)                 
    mang=Button(root,text="Managment",font=("Airal black",60),bg="#E5B4F3",fg="#6C3483",width=10,relief=GROOVE,bd=15)
    mang.place(x=500,y=200)
  
    
    cust=Button(root,text="Customer",font=("Airal black",60),bg="#E5B4F3",fg="#6C3483",width=10,relief=GROOVE,bd=15,command=self.Bill_App())
