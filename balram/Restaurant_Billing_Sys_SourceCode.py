...
class Bill_App:
    def __init__(self,root):
        ...
        passw1.pack()
        loginbutton=Button(center,text="login",font=("Airal 20"),command=login,relief=SUNKEN,bg="#A569BD",fg="white",bd=5)
    ...
    def login(self,root):
        ...
        title=Label(self.root,text="Billing System",bd=14,relief=RIDGE,font=("Arial Black",20),bg="#A569BD",fg="white").pack(fill=X)
        #===================================variables=======================================================================================
        ...
        details=LabelFrame(self.root,text="Customer Details",font=("Arial Black",12),bg="#A569BD",fg="white",relief=GROOVE,bd=12)
